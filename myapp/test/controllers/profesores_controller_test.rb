...
class ProfesoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profesore" do
    assert_difference('Profesore.count') do
      post profesores_url, params: { profesore: { Apellido: @profesore.Apellido, Materia: @profesore.Materia, Nombre: @profesore.Nombre } }
    end
  ...
  test "should update profesore" do
    patch profesore_url(@profesore), params: { profesore: { Apellido: @profesore.Apellido, Materia: @profesore.Materia, Nombre: @profesore.Nombre } }
