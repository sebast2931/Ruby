...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { Dia: @curso.Dia, Hora: @curso.Hora, Nombre: @curso.Nombre } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { Dia: @curso.Dia, Hora: @curso.Hora, Nombre: @curso.Nombre } }
