...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { Apellidos: @alumno.Apellidos, Correo: @alumno.Correo, Direccion: @alumno.Direccion, Nombre: @alumno.Nombre, Telefono: @alumno.Telefono } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { Apellidos: @alumno.Apellidos, Correo: @alumno.Correo, Direccion: @alumno.Direccion, Nombre: @alumno.Nombre, Telefono: @alumno.Telefono } }
